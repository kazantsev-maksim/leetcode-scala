...
import com.leetcode.easy.HashTableTopic.{romanToInt, twoSum, wordPattern}
...
final class HashTableTopicSpec extends AnyFlatSpec with should.Matchers {
  ...
  it should "twoSum" in {
    ...
    testCases.foreach { case (nums, target, expected) =>
  ...
  it should "wordPattern" in {
    ...
    testCases.foreach { case (pattern, s, expected) =>
